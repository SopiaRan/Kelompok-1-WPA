...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/anggota.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/css/anggotatambah.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/css/pengaduanadmin.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/css/tanggapi.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/css/detailpengaduan.css') ?>">
     ...
     <img style="width:30%;" src="<?= base_url('assets/images/logo/hima.png') ?>" alt="logo" />
      ...
      <nav class="sidebar-nav">
        ...
        <li class="nav-item mb-2">
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin/tanggapan')?>">
              <span class="icon">
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin/akun_pengguna')?>">
              <span class="icon">
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin/rekap')?>">
              <span class="icon">
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-file-isr"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 3v4a1 1 0 0 0 1 1h4" /><path d="M15 3v4a1 1 0 0 0 1 1h4" /><path d="M6 8v-3a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-7" /><path d="M3 15l3 -3l3 3" /></svg>
              </span>
          ...
          <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-6">
              <div class="header-right">
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="assets/images/profile/HIMASIFOR.png" alt="" />
                        </div>
                        <div>
                  ...
                  <div class="author-info flex items-center gap-3 p-2">
                    <div class="content">
                      <h4 class="text-base font-semibold text-black dark:text-white mb-1">
                        <?= esc(session()->get('username')) ?>
                      </h4>
                      <a href="#" class="text-sm text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white">
                ...
                <li class="divider my-1 border-t border-gray-200 dark:border-gray-700"></li>
                <li class="divider my-1 border-t border-gray-200 dark:border-gray-700"></li>
                <li>
                  <a href="<?= base_url('auth/logout') ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-800">
                    <i class="lni lni-exit text-lg"></i> Keluar
                  </a>
                </li>
